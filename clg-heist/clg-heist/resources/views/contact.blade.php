    ...
    <section class="ftco-section contact-section ftco-degree-bg">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span>  HPVJ+QP2, University Rd, Ganapati Nagar, Udaipur, Rajasthan 313001</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="tel://1234567920">1235 2355 98</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="mailto:info@yoursite.com">registra@mlsu.ac.in.</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span> <a href="#">https://www.mlsu.ac.in</a></p>
          </div>
        </div>
