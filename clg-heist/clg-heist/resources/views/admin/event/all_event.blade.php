                    ...
                    <div id="home" class="container tab-pane active"><br>
                        ...
                        <table class="table table-striped table-dark table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{$event->time}}</td>
                                <td><a href="/edit_event/{{$event->id}}" class="btn btn-danger">edit</a></td>
                                <td><a href="/delete_event/{{$event->id}}" class="btn btn-danger">delete</a></td>
                            </tr>   
                            @endforeach  
                        </table> 
                      </div>  
