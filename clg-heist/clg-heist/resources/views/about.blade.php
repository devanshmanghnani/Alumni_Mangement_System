    	...
    	<div class="container">
    		<div class="row d-flex">
    			...
    			<div class="col-md-6 pl-md-5 ftco-animate">
    				<h2 class="mb-4">Welcome to MLSU University Stablished Since 1898</h2>
    	...
    	<div class="container">
    		<div class="row d-md-flex justify-content-center">
    			<div class="col-md-9 about-video text-center">
    				<h2 class="ftco-animate">MLSU University is a Leading Schools Around the World</h2>
      ...
      <div class="container">
          <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section ftco-animate text-center">
              <h2 class="mb-4">What Our Alumni Says</h2>
            </div>
          </div>
            <div class="row d-flex">
              @if(count($reviews)>0)
              ...
              <div class="col-md-4 d-flex ftco-animate">
                <div class="testimony-wrap text-center">
                  ...
                  <img src="uploads/review_image/{{$rev->image}}" class="img-fluid" alt="Upcoming Event">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text">
                    <p class="mb-5">{{$rev->description}}</p>
...
<!-- Mirrored from technext.github.io/genius/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Aug 2022 08:49:47 GMT -->
</html>